...
export const EnjoyOnTVLang = {
  ...
  spanish: {
    ...
    paragraph:
      'Míralo en televisores inteligentes, PlayStation, Xbox, Chromecast, Apple TV, reproductores de Blu-ray y más.',
  },
};
export const DownloadShowLang = {
  en: {
    p1: 'Strenger things',
    p2: 'Downloading...',
  ...
  hindi: {
    p1: 'Strenger things',
    p2: 'डाउनलोड हो रहा है...',
    heading: 'ऑफ़लाइन देखने के लिए अपने शो डाउनलोड करें',
    paragraph:
  ...
  spanish: {
    p1: 'Cosas extrañas',
    p2: 'Descargando...',
    heading: 'Descarga tus programas para verlos sin conexión',
    paragraph:
      'Guarda tus favoritos fácilmente y siempre tendrás algo que ver.',
  },
};
export const WatchEveryWhereLang = {
  en: {
  ...
  spanish: {
    heading: 'Mira en todas partes',
    paragraph:
      'Míralo en televisores inteligentes, PlayStation, Xbox, Chromecast, Apple TV, reproductores de Blu-ray y más.',
  },
};
export const KidProfileLang = {
  en: {
  ...
  hindi: {
    heading: 'बच्चों के लिए प्रोफ़ाइल बनाएं',
    paragraph:
      'बच्चों को केवल उनके लिए बनाई गई जगह में उनके पसंदीदा पात्रों के साथ साहसिक यात्रा पर भेजें - आपकी सदस्यता के साथ निःशुल्क।',
  },
  spanish: {
    heading: 'Crear perfiles para niñas',
    paragraph:
      'Envíe a los niños a vivir aventuras con sus personajes favoritos en un espacio creado solo para ellos, gratis con su membresía.',
  },
};
...
export const ReadyToWatchLang = {
  ...
  spanish: {
    text: '¿Listo para mirar? Ingrese su correo electrónico para crear o reiniciar su membresía.',
    button: 'Empezar',
...
export const LoginLang = {
  ...
  hindi: {
    signin: 'साइन इन करें',
    signup: 'कृपया साइन अप करो',
    namePlaceholder: 'नाम*',
    emailPlaceholder: 'ईमेल*',
    passwordPlaceholder: 'पासवर्ड*',
    login: 'नए उपयोगकर्ता ? यहां रजिस्टर करें',
    register: 'क्या आपके पास पहले से एक खाता मौजूद है? यहां लॉगिन करें',
    or: 'या',
    google: 'गूगल से लॉगिन करें',
    github: 'Github के साथ लॉगिन करें',
  },
  ...
  spanish: {
    ...
    login: 'Nuevo Usuario ? Registrar aquí',
    register: '¿Ya tienes una cuenta? Entre aquí',
    or: 'o',
